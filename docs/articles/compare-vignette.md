# PLAID: comparison with other methods
...
include ssGSEA, GSVA, AUCell, Singscore, scSE and UCell. These methods
differ in preprocessing steps of ranking, centering, and normalization.
Despite methodical variations, these methods collectively offer vast
